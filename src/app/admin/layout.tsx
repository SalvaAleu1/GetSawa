...
{section:"Operations",items:[{href:"/admin/control-center",label:"Control Center"},{href:"/admin/operations",label:"Operational Signals"},{href:"/admin/customers",label:"Customers"},{href:"/admin/hosting",label:"Web Hosting"},{href:"/admin/email",label:"Business Email"},{href:"/admin/security",label:"CDN & DNS Security"},{href:"/admin/support",label:"Support"}]},
