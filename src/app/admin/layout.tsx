...
{section:"Operations",items:[{href:"/admin",label:"Overview"},{href:"/admin/operations",label:"Operations Center"},{href:"/admin/customers",label:"Customers"},{href:"/admin/hosting",label:"Web Hosting"},{href:"/admin/email",label:"Business Email"},{href:"/admin/security",label:"CDN & DNS Security"},{href:"/admin/support",label:"Support"}]},
...
{section:"Growth",items:[{href:"/admin/promotions",label:"Promotions"},{href:"/admin/coupons",label:"Coupons"},{href:"/admin/affiliates",label:"Affiliates"},{href:"/admin/blog",label:"Blog"}]},
{section:"System",items:[{href:"/admin/providers",label:"Providers"}]},
];
