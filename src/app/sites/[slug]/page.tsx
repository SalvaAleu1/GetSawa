...
export default async function PublicSitePage({params}:Params){const{slug}=await params;const data=await getPublishedProject(slug);if(!data)notFound();return <WebsiteRenderer content={data.content} pageSlug="home" basePath={`/sites/${slug}`}/>;}
